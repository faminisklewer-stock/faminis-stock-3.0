-- 0014_reconcile_master_catalog.sql
-- Reconcile the canonical product catalog and ensure all approved SKU/category combinations
-- are present and visible in the app, while legacy entries are hidden.
...
where p.active = true
  and not exists (
    select 1 from (
      values
        ('MKN-PRM'), ('MKN-JMB'), ('MKN-PRY'), ('MKN-STD'), ('MKN-ARD'), ('MKN-ARB'), ('MKN-ARA'), ('MKN-ART'), ('MKN-JGR'),
        ('MKN-TVPM'), ('MKN-TVTM'), ('MKN-TVPP'), ('MKN-TVTP'), ('MKN-TVPA'), ('MKN-TSM'), ('MKN-TSP'), ('MKN-TSPR'), ('MKN-VSC'),
        ('MKN-MXM'), ('MKN-SNT'), ('MKN-KDJ'), ('MKN-CRK'), ('MKN-BKJ'), ('MKN-BPG'), ('MKN-KMM'), ('MKN-KMP'), ('MKN-KPR'),
        ('MKN-KVL'), ('MKN-TGR'), ('MKN-TGS'), ('MKN-TGP'), ('MKN-TGT'), ('MKN-RND'), ('MKN-RNB'), ('MKN-STR'), ('MKN-HDR'),
        ('MKN-BTC'), ('SRG-RBD'), ('SRG-PLM'), ('SRG-KCW'), ('SRG-GJD'), ('SRG-WDM'), ('SRG-BLL'), ('SRG-AZK'), ('SRG-GYR'),
        ('SJD-MRB'), ('SJD-TBT'), ('SJD-TBB'), ('SJD-MKA'), ('SJD-AKB'), ('SJD-EMB'), ('SJD-TRV'), ('SJD-SUD'), ('SJD-ALD'),
        ('SJD-ALM'), ('SJD-BTK'), ('SJD-JML'), ('DST-BSA'), ('DST-PRM'), ('DST-JPR'), ('DST-JBS'), ('DST-KLL'), ('DST-CHB'),
        ('DST-CAP'), ('BSW-LDR'), ('BSW-LDB'), ('BSW-KFB'), ('BSW-KFP'), ('BSW-STJ'), ('BSW-CLN'), ('BSP-KBG'), ('BSP-KAR'),
        ('BSP-KTR'), ('BSP-KPT'), ('BSP-GLK')
    ) as approved(sku)
    where approved.sku = p.sku
  );
