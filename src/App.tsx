    ...
    <div className="app-shell">
      <aside className="sidebar">
        ...
        <nav className="main-nav" aria-label="Main navigation">
          ...
          {!isMasterUser && <><p className="nav-label nav-label-spaced">Operasional</p><div className="sync-card"><div className="sync-line"><span className="live-dot"></span><strong>Mode PWA</strong></div><span>Kasir, transfer, dan laporan</span></div></>}
